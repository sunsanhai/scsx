package org.algorithmcontestdatacollect.crawlerendpoint2.CronService;
...
import org.algorithmcontestdatacollect.crawlerendpoint2.Services.UserAccountService;
...
public class CodeforcesCron {
    ...
    public void getSubmitCode() {
        ...
        for (var entity : entities) {
            ...
            Optional<CfAccountEntity> byId = cfAccountRepository.findById(entity.getCfid());
            if (byId.isPresent()) {
